...
import { gruposDePessoas } from "../data/pessoasData";
...
export default function Pessoas() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
      <FaixaDeModo texto="Pessoas" cor="#58D68D" />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="bg-white rounded-3xl border-4 border-green-200 shadow-sm p-6 lg:p-8 mb-10">
            ...
            <p className="text-lg text-gray-700 max-w-3xl">
              Escolha uma pessoa ou uma frase relacionada a pessoas próximas.
              Ao clicar em um card, o sistema fala a comunicação selecionada.
            </p>
          </section>

          {gruposDePessoas.map((grupo) => (
