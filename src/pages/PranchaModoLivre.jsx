...
import { pranchasModoLivre } from "../data/pranchasModoLivreData";
import { useFavoritos } from "../hooks/useFavoritos";
import { useAuth } from "../contexts/AuthContext";
import { falar } from "../utils/falar";

export default function PranchaModoLivre() {
  const { slug } = useParams();
  const prancha = pranchasModoLivre[slug];
  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
      <FaixaDeModo texto={prancha.titulo} cor="#58D68D" />
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {grupo.comunicacoes.map((comunicacao) => {
                  const item = {
                    ...
                    categoria: `${prancha.titulo} - ${grupo.titulo}`,
                    origem: prancha.titulo,
