...
import { gruposDeInteracao } from "../data/interacaoData";
...
export default function Interacao() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
        <FaixaDeModo texto="Interação" cor="#58D68D" />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="bg-white rounded-3xl border-4 border-green-200 shadow-sm p-6 lg:p-8 mb-10">
            ...
            <p className="text-lg text-gray-700 max-w-3xl">
              Escolha uma comunicação para cumprimentar, responder, pedir
              atenção ou interagir com outras pessoas. Ao clicar em um card, o
              sistema fala a frase selecionada.
            </p>
          </section>

          {gruposDeInteracao.map((grupo) => (
