        ...
        {categorias.map((item, index) => {
          ...
          return (
            <Card
              key={index}
              {...cardProps}
              className="bg-white rounded-2xl border-4 border-blue-150 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 overflow-hidden group cursor-pointer flex flex-col"
            >
